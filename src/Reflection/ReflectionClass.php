...
class ReflectionClass implements Reflection
{
    ...
    private function createMethodsFromTrait(ReflectionMethod $method): array
    {
        ...
        $createMethod = function (?string $aliasMethodName) use ($methodAst, $method) : ReflectionMethod {
            return ReflectionMethod::createFromNode($this->reflector, $methodAst, $this->locatedSource, $method->getDeclaringClass()->getDeclaringNamespaceAst(), $method->getDeclaringClass(), $this, $this, $aliasMethodName);
        };
    ...
    private function getParentMethods(): array
    {
        return array_merge([], ...array_map(function (ReflectionClass $ancestor): array {
            return array_map(function (ReflectionMethod $method) : ReflectionMethod {
                return ReflectionMethod::createFromNode($this->reflector, $method->getAst(), $this->locatedSource, $method->getDeclaringClass()->getDeclaringNamespaceAst(), $method->getDeclaringClass(), $method->getImplementingClass(), $this, $method->getAliasName());
            }, $ancestor->getMethods());
