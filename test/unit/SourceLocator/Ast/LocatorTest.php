...
class LocatorTest extends TestCase
{
    ...
    public function testReflectingTopLevelConstantByConst(): void
    {
        ...
        $constantInfo = $this->locator->findReflection(new DefaultReflector(new StringSourceLocator($php, $this->locator)), new LocatedSource($php, 'FOO', null), $this->getIdentifier('FOO', IdentifierType::IDENTIFIER_CONSTANT));
