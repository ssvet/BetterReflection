...
/**
 * @covers \PHPStan\BetterReflection\Reflection\Adapter\ReflectionMethod
 */
class ReflectionMethodTest extends TestCase
{
    ...
    public function testGetAttributesWithName(): void
    {
        ...
        $reflectionMethodAdapter = new ReflectionMethodAdapter($betterReflectionMethod);
        $attributes              = method_exists($reflectionMethodAdapter, 'getAttributes') ? $reflectionMethodAdapter->getAttributes('SomeAttribute') : [];
