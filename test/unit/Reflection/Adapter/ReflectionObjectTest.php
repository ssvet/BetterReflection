...
/**
 * @covers \PHPStan\BetterReflection\Reflection\Adapter\ReflectionObject
 */
class ReflectionObjectTest extends TestCase
{
    ...
    public function testGetAttributesWithName(): void
    {
        ...
        $attributes = method_exists($reflectionObjectAdapter, 'getAttributes') ? $reflectionObjectAdapter->getAttributes('SomeAttribute') : [];
