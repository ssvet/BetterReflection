...
/**
 * @covers \PHPStan\BetterReflection\Reflection\StringCast\ReflectionParameterStringCast
 */
class ReflectionParameterStringCastTest extends TestCase
{
    ...
    public function toStringProvider() : array
    {
        return [
            ...
            ['parametersWithNullableBuiltInTypes', 'int', 'Parameter #1 [ <required> ?int or NULL $int ]'],
            ['parametersWithNullableBuiltInTypes', 'float', 'Parameter #2 [ <required> ?float or NULL $float ]'],
            ['parametersWithNullableBuiltInTypes', 'bool', 'Parameter #3 [ <required> ?bool or NULL $bool ]'],
            ...
            ['parametersWithNullableBuiltInTypesWithDefaultValue', 'int', 'Parameter #1 [ <optional> ?int or NULL $int = 0 ]'],
            ['parametersWithNullableBuiltInTypesWithDefaultValue', 'float', 'Parameter #2 [ <optional> ?float or NULL $float = 0.0 ]'],
            ['parametersWithNullableBuiltInTypesWithDefaultValue', 'bool', 'Parameter #3 [ <optional> ?bool or NULL $bool = true ]'],
