...
PHP;
    ...
    public function testGetModifiers(string $className, int $expectedModifier, array $expectedModifierNames): void
    {
        ...
        self::assertSame($expectedModifierNames, CoreReflection::getModifierNames($classInfo->getModifiers()));
    }
    ...
    public function testGetConstantsReturnsAllConstantsRegardlessOfVisibility(): void
    {
        ...
        array_walk($expectedConstants, static function ($constantValue, string $constantName) use ($reflection): void {
            ...
            self::assertSame($constantValue, $reflection->getConstant($constantName), 'Constant value for ' . $constantName . ' does not match');
        });
    }
